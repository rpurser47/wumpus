...
export const caveLayout: Room[] = [
  ...
  },
  {
    ...
    x: 200,
    y: 200,
    connections: [1, 5, 7, 11],
    hazard: Hazard.None,
    description:
      'A crossroads of several tunnels. Echoes bounce off the walls from all directions.',
  },
  {
    id: 7,
    x: 300,
  ...
  },
  {
    ...
    hazard: Hazard.None,
    description:
      'A room where the ceiling opens to a natural chimney. A shaft of light filters down.',
  },
  {
    id: 13,
    x: 340,
  ...
  },
  {
    ...
    hazard: Hazard.None,
    description:
      'A deep chamber with the sound of distant water. Stalactites hang like daggers above.',
  },
];
